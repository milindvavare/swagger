    		...
    		<div class="col-md-12">
    			<div class="card" style="padding: 20px 20px;">
    				...
    				<div class="container" id="result_success">
    					...
    					<div class="row" id="individual_summaries_flow_a">
    					


    					</div>
    					<div class="row" id="individual_summaries_flow_b">
...
<div class="bottom_div">
  ...
  <div class="container">	
	<div class="row">
		<div class="col-md-4">
			<textarea class="prompt_textarea prompt_1" placeholder="prompt 1"></textarea>
		</div>
		<div class="col-md-4">
			<textarea class="prompt_textarea prompt_2" placeholder="prompt 2"></textarea>
		</div>
		<div class="col-md-4">
			<button style="margin-top: 20%;" class="btn btn-success submit_prompt">Submit</button>

			<button style="margin-top: 20%;background: #48C9B0;" class="btn btn-success wait_btn">Please Wait..</button>
		</div>
	</div>
 </div>
</center>
				  ...
				  $('#meta_summary_flow_a').html(result_final['meta_summary_flow_a']);
					...
					for (var i = 0; i < individual_summaries_flow_a.length ; i++) {
						 // console.log(individual_summaries_flow_a[i]);
						  in_sum_data_a += '<div class="col-md-6"><div style="padding: 10px 10px;" class="box">'+individual_summaries_flow_a[i]+'</div></div> ';
					...
					for (var i = 0; i < individual_summaries_flow_b.length ; i++) {
						  ...
						  in_sum_data_b += '<div class="col-md-6"><div style="padding: 10px 10px;" class="box">'+individual_summaries_flow_b[i]+'</div></div> ';
...
$(document).on('click', '.log_comments_submit', function(){
	//alert(value);
	var ep1_query_id = '076f149ec0456415348dfbba1e0cffac';
	var ep2_query_id = '2ca4f1d0725ad539a51c8aa69b1e169c';
